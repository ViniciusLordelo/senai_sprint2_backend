...
{
    interface ClassesHabilidadesRepository : ClassesHabilidade
    {
        ...
        public void AtualizarClasses(int id, Class ClassAtualizada)
        {
            ...
            if (ClassAtualizada.ClassesIdHabilidades == null)
            {
                ClassBuscada.ClassesIdHabilidades = ClassAtualizada.ClassesIdHabilidades;
